...
kable(arrange(CanAPF, desc(n)), digits = 2, caption = "Average number of articles per faculty member per year, by institution")
```
...
UScomp <- rbind(Alberta, CarnegieMellon, filter(ColoradoBoulder, Department != "Aerospace Engineering Sciences" & Department != "Computer Science"), Duke, filter(Florida, Department == "Biomedical Engineering" | Department == "Chemical Engineering" | Department == "Electrical & Computer Engineering" | Department == "Material Science & Engineering" | Department == "Mechanical & Aerospace Engineering"), filter(GeorgiaTech, Department != "Industrial and Systems Engineering" & Department != "Aerospace Engineering"), filter(IllinoisUC, Department == "Bioengineering" | Department == "Chemical $ Biomolecular Engineering" | Department == "Civil & Environmental Engineering" | Department == "Electrical & Computer Engineering" | Department == "Materials Science & Engineering" | Department == "Mechanical Science and Engineering"), filter(Michigan, Department != "Aerospace Engineering" & Department != "Climate and Space Sciences and Engineering" & Department != "Industrial and Operations Engineering" & Department != "Integrative Systems and Design" & Department != "Naval Architecture and Marine Engineerin" & Department != "Nuclear Engineering and Radiological Sciences"), filter(Minnesota, Department != "Aerospace Engineering and Mechanics" & Department != "Chemistry" & Department != "Earth Sciences" & Department != "School of Mathematics" & Department != "School of Physics and Astronomy"), filter(UTAustin, Department != "Aerospace Engineering and Engineering Mechanics" & Department != "Operations research and Industrial Engineering" & Department != "Texas Engineering Executive Education"), filter(Wisconsin, Department != "Engineering Physics" & Department != "Industrial & Systems Engineering"))
